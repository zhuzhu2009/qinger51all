...
#if 0
//#define  ENC28J60_CSL()    (GPIOA->ODR &= ~GPIO_Pin_4)
//#define  ENC28J60_CSH()    (GPIOA->ODR |= GPIO_Pin_4)
#define  ENC28J60_CSL()    (GPIOB->ODR &= ~NET_CS)    //SMS board  PB12
#define  ENC28J60_CSH()    (GPIOB->ODR |= NET_CS)


#define   ENC28J60_RSTL()   (GPIOB->ODR &= ~(NET_RST))
#define   ENC28J60_RSTH()   (GPIOB->ODR |= NET_RST)
#endif
...
void enc28j60PhyWrite(u8 address, u16 c);
...
/*#define tapdev_read() enc28j60PacketReceive(UIP_BUFSIZE, uip_buf)
#define tapdev_send() enc28j60PacketSend(uip_len, uip_buf)*/
